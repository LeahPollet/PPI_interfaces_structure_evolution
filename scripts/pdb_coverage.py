...
def load_sequences():
    fH = open('../data/external/blastToPDB/pdb_reduced.faa', 'r') # All proteins with aa sequences on the PDB 
...
def main():
    ...
    pdbDir = '../data/processed/assemblies'     # All PDBids to include in the summary file (assemblies folder generated by the structural_homology_maping.py file)
    opath = '../data/processed/pdb_lengths.csv' # Location for the output summary file
